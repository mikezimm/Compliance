...
import * as strings from 'ComplianceOpsWebPartStrings';
import { IComplianceOpsWebPartProps,  } from './IComplianceOpsWebPartProps';
import ComplianceOps from './components/ComplianceOps';
import { IComplianceOpsProps } from './components/IComplianceOpsProps';
...
export default class ComplianceOpsWebPart extends FPSBaseClass<IComplianceOpsWebPartProps> {
  ...
  public render(): void {
    ...
    const element: React.ReactElement<IComplianceOpsProps> = React.createElement(
      ComplianceOps,
      {
