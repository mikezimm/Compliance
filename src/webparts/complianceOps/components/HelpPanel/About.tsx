...
export const panelVersionNumber = '2023-03-14 -  1.0.0.22'; //Added to show in panel
...
export function aboutTable( bannerProps: IWebpartBannerProps ): { table: IHelpTable } {
    ...
    table.rows.push( createAboutRow('2023-03-14',"1.0.0.22","", bannerProps.showRepoLinks === true ? bannerProps.gitHubRepo : null ) );
    table.rows.push( createAboutRow('2023-03-12',"1.0.0.21","#89, #90, #91, #92", bannerProps.showRepoLinks === true ? bannerProps.gitHubRepo : null ) );
    table.rows.push( createAboutRow('2023-03-12',"1.0.0.20","#87", bannerProps.showRepoLinks === true ? bannerProps.gitHubRepo : null ) );
    table.rows.push( createAboutRow('2023-03-12',"1.0.0.19","#81, #83, #84, #85", bannerProps.showRepoLinks === true ? bannerProps.gitHubRepo : null ) );
    table.rows.push( createAboutRow('2023-03-12',"1.0.0.18","#74, #75, #76, #78 - RigItems tab", bannerProps.showRepoLinks === true ? bannerProps.gitHubRepo : null ) );
    table.rows.push( createAboutRow('2023-03-12',"1.0.0.17","#75", bannerProps.showRepoLinks === true ? bannerProps.gitHubRepo : null ) );
    table.rows.push( createAboutRow('2023-03-10',"1.0.0.16","#72", bannerProps.showRepoLinks === true ? bannerProps.gitHubRepo : null ) );
    table.rows.push( createAboutRow('2023-03-10',"1.0.0.15","#65, #66, #67, #68, #71", bannerProps.showRepoLinks === true ? bannerProps.gitHubRepo : null ) );
    table.rows.push( createAboutRow('2023-03-03',"1.0.0.14","#64", bannerProps.showRepoLinks === true ? bannerProps.gitHubRepo : null ) );
    table.rows.push( createAboutRow('2023-03-01',"1.0.0.12","#62- RigItems api fix", bannerProps.showRepoLinks === true ? bannerProps.gitHubRepo : null ) );
    table.rows.push( createAboutRow('2023-02-28',"1.0.0.11","#51, #52, #53, #54, #56, #57 - Happy Birthday to Me!", bannerProps.showRepoLinks === true ? bannerProps.gitHubRepo : null ) );
