 ...
 */
  ...
  //   itemsPerPage={ 20 }
  //   pageWidth={ 1000 }
  //   topButtons={ buttonAllLists }
  //   stateSource={ { ...stateSource, ...{ refreshId: refreshId } } }
  //   startQty={ 20 }
  //   showItemType={ false }
  //   debugMode={ debugMode }
  //   renderRow={ createAllListsRow }
  ...
  const AllListsPageElement: JSX.Element = mainPivotKey !== 'AllLists' ? null : <div className = { styles.page } style={ null }>
    ...
    {
      <ReactJson src={ stateSource.items } name={ primarySource.defType } collapsed={ false } displayDataTypes={ false } displayObjectSize={ false }
