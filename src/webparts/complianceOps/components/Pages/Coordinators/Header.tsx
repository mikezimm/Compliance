...
export interface ICoordinatorsPageProps {
...
const CoordinatorsPageHook: React.FC<ICoordinatorsPageProps> = ( props ) => {
 ...
 */
  ...
  const MainContent: JSX.Element = <div style={{ cursor: 'default' }}>
    <ul>
      ...
      <li>If you have any questions about records in your specific facility, this is a good place to start.</li>
  ...
  const CoordinatorsPageElement: JSX.Element = contactPivotKey !== 'Coordinators' ? null : <div className = { styles.page } style={ null }>
    { InfoElement }
    {/* <div id={ 'ComplCoordinatorsStartTour' } ><Icon iconName={ 'MapPin' }/></div> */}
    { TeachMe }
  </div>;

  return ( CoordinatorsPageElement );

}

export default CoordinatorsPageHook;