...
export class PersonaCard extends React.Component<
  ...
  public async componentDidMount(): Promise<void> {
    if (Environment.type !== EnvironmentType.Local) {
      ...
      const livePersonaCard: JSX.Element = sharedLibrary.LivePersonaCard;
  ...
  private _PersonaCard(): JSX.Element {
    ...
    const docCardClassFinal = [ docCardClass , sizeBracket === 'large' ? styles.documentCardBorder : styles.documentCardNoBorder ].join(' ');
    ...
    const personaClass = [styles.persona , sizeBracket === 'small' ? styles.flexDirRow : null ].join(' ');
  ...
  public render(): React.ReactElement<IPersonaCardProps> {
    ...
    const sizeBracket = this.props.size === PersonaSize.size16 || this.props.size === PersonaSize.size10 ? 'small' : 'large';
    const personaContainer =  sizeBracket === 'large' ? styles.personaContainerNormal : styles.personaContainerSmall ;
